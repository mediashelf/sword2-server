...
public class ServiceDocument {
    ...
    public Service getAbderaService() {
        ...
        Service abderaService = (Service) service.clone();
        abderaService.addSimpleExtension(UriRegistry.SWORD_VERSION, version);
        if (maxUploadSize > -1) {
            abderaService.addSimpleExtension(UriRegistry.SWORD_MAX_UPLOAD_SIZE,
                    Integer.toString(maxUploadSize));
        }
    ...
    public void addWorkspace(SwordWorkspace workspace) {
        ...
        service.addWorkspace(abderaWorkspace);
    }
}
